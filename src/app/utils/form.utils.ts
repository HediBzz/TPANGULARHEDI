...
export const buildEditUserForm = (user: User): FormGroup => {
    return new FormGroup({
        firstName: new FormControl<string>(user.firstName, [Validators.required, Validators.minLength(5)]),
        lastName: new FormControl<string>(user.lastName, [Validators.required, Validators.minLength(5)]),
        email: new FormControl<string>(user.email, [Validators.required, Validators.email]),
        occupation: new FormControl<string>(user.occupation, [Validators.required, Validators.minLength(2)]),
        bio: new FormControl<string>(user.bio, [Validators.required, Validators.minLength(10)]),
